...
class SeEpub:
	...
	def build(self, run_epubcheck: bool, check_only: bool, build_kobo: bool, build_kindle: bool, build_pdf: bool, output_directory: Path, proof: bool) -> None:
		"""
		...
		build(self, run_epubcheck, check_only, build_kobo, build_kindle, build_pdf, output_directory, proof)
